 ...
 * which causes  the last one  to be  found at position  string.length -
 * 1. In  other words,  a two-character  string  has length  2, and  its
...
const countChar = (string, char) => {
	let count = 0;
	for (let i in string) if (string[i] === char) count++;
	return count;
}
